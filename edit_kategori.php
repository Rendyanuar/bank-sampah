...
$query_tampil = "SELECT * FROM kategori_sampah WHERE id = '$id'";
$hasil_tampil = mysqli_query($koneksi, $query_tampil);

if (mysqli_num_rows($hasil_tampil) == 0) {
    header("Location: kategori_sampah.php");
    exit;
}
...
if (isset($_POST['submit_edit'])) {
    ...
    $query_update = "UPDATE kategori_sampah SET nama_barang = '$nama_barang', harga_barang = '$harga_barang' WHERE id = '$id'";
    ...
    if (mysqli_query($koneksi, $query_update)) {
        ...
        $pesan = "<div class='alert error'>Gagal mengupdate data.</div>";
    }
}
...
<head>
    ...
    <title>Edit Kategori - Bank Sampah Induk</title>
    ...
    <style>
        ...
        .input-wrapper input { flex: 1; padding: 12px 15px; border: none; background: transparent; outline: none; font-size: 14px; color: #333;}
...
<body>
    ...
    <div class="main-content">
        <div class="header">
            <h3><i class="fa fa-bars mobile-menu-btn" onclick="toggleMobileMenu()"></i> Edit Kategori Sampah</h3>
                ...
                <form action="" method="POST">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="number" name="harga_barang" value="<?php echo htmlspecialchars($data['harga_barang']); ?>" required min="0">
                        </div>
                    </div>
                    
                    <div class="button-group">
                        <a href="kategori_sampah.php" class="btn-back"><i class="fa fa-arrow-left"></i> &nbsp;Batal</a>
                        <button type="submit" name="submit_edit" class="btn-submit">SIMPAN PERUBAHAN</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="successModal" class="modal-overlay" style="display: flex;">
        <div class="modal-box">
            ...
            <div class="modal-body">
                ...
                <p>Harga dan nama kategori berhasil disimpan.</p>
                <button class="btn-confirm-green" onclick="window.location.href='kategori_sampah.php'">Kembali ke Tabel</button>
            </div>
        </div>
    </div>
    <?php endif; ?>
